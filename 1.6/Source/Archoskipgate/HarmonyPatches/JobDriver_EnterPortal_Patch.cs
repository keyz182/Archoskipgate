...
{
    public static IEnumerable<Toil> MakeNewToils_Actual(JobDriver_EnterPortal _this, Building_SkipGate gate)
    {
    ...
    public static bool MakeNewToils_Patch(JobDriver_EnterPortal __instance, ref IEnumerable<Toil> __result)
    {
        ...
        Building_SkipGate gate = target as Building_SkipGate;
